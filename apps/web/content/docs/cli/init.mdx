---
title: awesome-slide init
description: Scaffold a new workspace.
---

```npm
npx @awesome-slide/cli init [directory]
```
...
and writes the matching preset into `awesome-slide.config.ts` (see the
...
├── themes/                 # empty
├── awesome-slide.config.ts    # framework config
