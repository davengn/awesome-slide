...
The inspector is a dev-only overlay built into the Awesome Slide runtime. Toggle
...
tag, and text snippet — to `node_modules/.awesome-slide/current.json` whenever
