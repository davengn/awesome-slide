...
| pkg-demo | `apps/demo/package.json`, `apps/demo/tsconfig.json` | `@open-slide/core`, `open-slide` scripts/types | demo | `@awesome-slide/core`, `awesome-slide` scripts/types | alias | one-major-cycle | build | done | Demo uses canonical package/scripts/types and keeps legacy config in TypeScript includes for fallback validation. |
...
| docs-root | `README.md`, `packages/core/README.md`, `packages/cli/README.md`, `AGENTS.md`, `CLAUDE.md` | `open-slide`, `@open-slide/*` | docs | `Awesome Slide`, `@awesome-slide/*` | replace | n/a | inventory-scan | done | Remaining legacy mentions are migration or compatibility context. |
| docs-web | `apps/web/content/docs/**`, `apps/web/components/landing/**`, `apps/web/lib/**` | `open-slide`, `@open-slide/*` | docs | `Awesome Slide`, `@awesome-slide/*` | replace | n/a | build | done | Web docs, shared layout name, landing copy, and docs chrome use canonical branding. |
...
| demo-copy | `apps/demo/**` | `open-slide`, `@open-slide/*` | demo | `Awesome Slide`, `@awesome-slide/*` | replace | n/a | build | done | Demo slide/theme examples are rebranded; legacy config fallback remains intentional. |
...
| github-copy | `.github/ISSUE_TEMPLATE/*.yml` | `open-slide`, `@open-slide/*` | github | `Awesome Slide`, `@awesome-slide/*` | replace | n/a | inventory-scan | done | Issue forms reflect canonical packages and product naming. |
